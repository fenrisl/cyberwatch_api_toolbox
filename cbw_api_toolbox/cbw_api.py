...
class CBWApi: # pylint: disable=R0904
    ...
    def fetch_importer_scripts(self, params=None):
        """GET request to /api/v2/cbw_scans/scripts to get a list of all importer scripts"""
    ...
    def fetch_importer_script(self, script_id):
        """GET request to /api/v2/cbw_scans/scripts/{SCRIPT_ID} to get a specific importer script"""
    ...
    def upload_importer_results(self, content):
        """POST request to /api/v2/cbw_scans/scripts to upload script result"""
